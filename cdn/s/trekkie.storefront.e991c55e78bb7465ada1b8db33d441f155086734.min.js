    ...
    var e = {
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${p}/api/unstable/graphql.json`, f).then((e => {
                        ...
                        const s = 31536e6,
                            ...
                            v = a.data.consentManagement.cookies.origReferrerCookie;
                        return r.writeCookie(i.CONSENT_COOKIE_NAME, l, s, _), g && v && (r.writeCookie(c, l, d, g), r.writeCookie(u, l, d, v)), f !== l && (r.writeCookie(i.CONSENT_COOKIE_NAME, f, s, _), g && v && (r.writeCookie(c, f, d, g), r.writeCookie(u, f, d, v))), o.dispatchEvents(e), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var h = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({
                            ...
                            asset_version_id: "e991c55e78bb7465ada1b8db33d441f155086734",
                            ...
                            analytics_allowed: v.analyticsProcessingAllowed(),
                            marketing_allowed: v.marketingAllowed(),
                            sale_of_data_allowed: v.saleOfDataAllowed(),
                            preferences_allowed: v.preferencesProcessingAllowed()
                        ...
                        var e = this.options;
                        return e.facebookAppPixelId ? [e.facebookAppPixelId] : []
            ...
            4252: function(e, t, n) {
                    ...
                    if (void 0 === o && (!l.default.isEnabled(l.TREKKIE_COOKIE_DOMAIN_FIX) || T(e)))
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (E(e, a, 0, t), y(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
                ...
                t.parseDocumentCookie = v, t.cookieImpl = {
                    ...
                    void 0 === r && (r = "Lax"), h(e), E(e, t, n ? 31104e6 : 18e5, o, r)
                }, t.clear = function(e) {
                    h(e), E(e, "", -1, o), E(e, "", -1, "")
                ...
                }, t.determineCookieDomain = h, t.resetCookieImpl = function() {
                    o = void 0, r = void 0
                }
            },
            4779: function(e, t, n) {
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "e991c55e78bb7465ada1b8db33d441f155086734",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
            ...
            1074: function(e, t, n) {
                    ...
                    E = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "e991c55e78bb7465ada1b8db33d441f155086734",
                ...
                t.Tricorder = E, t.replayAnalyticsQueue = function(e, t) {
        ...
        function() {
            ...
            try {
                ...
                if (g) {
                    ...
                    var v = window[r],
                        h = window.trekkie = new e.Tricorder(i, g, (function() {
                            window[r] = h, window._visit = {
                                tag: function() {},
